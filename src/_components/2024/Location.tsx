...
export function Location() {
  const t = useTranslations("app.2024.location");
  ...
  return (
    <section className="flex justify-center bg-[#4CBCFF]">
      <div className="flex max-w-[1366px] flex-col items-center px-6 py-20 text-center md:px-10 md:py-40 xl:px-40">
        <h2 className="mb-2 text-sm font-medium text-white md:mb-4 md:text-2xl xl:mb-4">{t("eyebrow")}</h2>
        <h3 className="mb-4 text-2xl font-bold md:text-[52px] md:leading-none xl:text-6xl">{t("title")}</h3>
        <div className="mb-9 items-center md:mb-[72px] md:flex">
          <div className="mb-2 flex items-center justify-center md:mr-8 md:mb-0">
            <img
