...
export function Location() {
  const t = useTranslations("app.2025.location");
    ...
    <section className="bg-[#215BF6]">
      <div className="px-6 py-20 md:px-10 md:py-40">
        <div className="mb-6 text-center md:mb-[72px]">
          ...
          <h3 className="mb-4 text-2xl font-bold text-[#FAFAFA] md:text-5xl">{t("title")}</h3>
          <div className="md:flex md:items-center md:justify-center">
            <div className="mb-2 flex items-center justify-center text-[#FAFAFA] md:mr-8 md:mb-0">
              <img
                src="/2025/date.svg"
                alt={t("dateIconAlt")}
