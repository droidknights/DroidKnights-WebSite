      ...
      <div className="px-6 py-10 md:px-10 md:py-[120px]">
        <div className="mx-auto max-w-[950px]">
          <div className="mb-8 rounded-[10px] bg-white/15 px-6 py-10 text-center md:mb-10">
            <h3 className="mb-4 text-center font-bold leading-normal text-white md:mb-8 md:text-[32px] md:leading-normal">
            ...
            <div className="flex justify-center">
              <button
                type="button"
                className="flex h-[39px] w-[138px] items-center justify-center rounded bg-gradient-to-r from-[#5180FF] to-[#215BF6] text-xs font-semibold text-white md:h-[64px] md:w-[300px] md:text-xl"
                onClick={() => {
